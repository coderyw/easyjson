# easyjson [![Build Status](https://github.com/coderyw/easyjson/actions/workflows/easyjson.yml/badge.svg)](https://github.com/coderyw/easyjson/actions/workflows/easyjson.yml) [![Go Report Card](https://goreportcard.com/badge/github.com/coderyw/easyjson)](https://goreportcard.com/report/github.com/coderyw/easyjson)
...
```sh
# for Go < 1.17
go get -u github.com/coderyw/easyjson/...
```
#### or
```sh
# for Go >= 1.17
go get github.com/coderyw/easyjson && go install github.com/coderyw/easyjson/...@latest
```
### Run:
```sh
...
Please see the [GoDoc](https://godoc.org/github.com/coderyw/easyjson)
...
listing](https://godoc.org/github.com/coderyw/easyjson) for the full listing of
...
Please see the [GoDoc listing](https://godoc.org/github.com/coderyw/easyjson/buffer)
